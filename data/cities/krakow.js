import krakowImg from '@public/assets/images/area/cities/krakow.webp'

export const krakow = {
    city: "Kraków",
    img: krakowImg,
    metaTitle: "Strony www Kraków - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Kraków oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",

    header: {
        h1: "Strony internetowe Kraków",
        ...
        paragraph2: "Każda strona www Kraków jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },

    whyCity: {
        mainTitle: "Profesjonalne strony i sklepy internetowe Kraków",
        decoration: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        subTitle: "Projektowanie stron internetowych Kraków - nowoczesność i jakość w jednym miejscu",
        ...
        titleWhyInvest: "Dlaczego warto zainwestować w stronę internetową dla firmy w Krakowie?",
        elements: [
            {
            ...
            },
            {
                ...
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy z Krakowa`,
            ...
            },
            {
                ...
                title: `Zdobędziesz klientów w Krakowie i okolicach`,
                desc: `Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów z Krakowa.`
            }
        ]
    },

    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Krakowie",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Krakowie",
        ...
        elements: [
            {
                ...
                desc: "Na początku poznajemy specyfikę Twojej działalności oraz cele biznesowe, aby stworzyć stronę internetową w Krakowie dopasowaną do Twoich oczekiwań."
            },
            {
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Krakowa",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Krakowa i okolic. Specjalizujemy się w:",
    },
    ...
    portfolio: {
        ...
        paragraph2: "Masz pomysł na stronę internetową w Krakowie?"
    },

    faq: {
        title: "Tworzenie stron internetowych w Krakowie - odpowiemy na wszystkie Twoje pytania",
