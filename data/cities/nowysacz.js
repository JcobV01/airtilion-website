...
export const nowysacz = {
    city: "Nowy Sącz",
    img: nowysaczImg,
    metaTitle: "Strony www Nowy Sącz - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Nowy Sącz oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",

    header: {
        h1: "Strony internetowe Nowy Sącz",
        ...
        paragraph2: "Każda strona www Nowy Sącz jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },
    ...
    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Nowym Sączu",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Nowym Sączu",
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Nowego Sącza",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Nowego Sącza i okolic. Specjalizujemy się w:",
    },
    ...
    faq: {
        ...
        elements: [
            ...
            {
                id: 2,
                question: "Ile kosztuje strona w Nowym Sączu?",
