import olsztynImg from '@public/assets/images/area/cities/olsztyn.webp'

export const olsztyn = {
    city: "Olsztyn",
    img: olsztynImg,
    metaTitle: "Strony www Olsztyn - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Olsztyn oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",

    header: {
        h1: "Strony internetowe Olsztyn",
        ...
        paragraph2: "Każda strona www Olsztyn jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },

    whyCity: {
        mainTitle: "Profesjonalne strony i sklepy internetowe Olsztyn",
        decoration: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        subTitle: "Projektowanie stron internetowych Olsztyn - nowoczesność i jakość w jednym miejscu",
        ...
        titleWhyInvest: "Dlaczego warto zainwestować w stronę internetową dla firmy w Olsztynie?",
        elements: [
            {
            ...
            },
            {
                ...
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy z Olsztyna`,
            ...
            },
            {
                ...
                title: `Zdobędziesz klientów w Olsztynie i okolicach`,
                desc: `Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów z Olsztyna.`
            }
        ]
    },

    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Olsztynie",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Olsztynie",
        ...
        elements: [
            {
                ...
                desc: "Na początku poznajemy specyfikę Twojej działalności oraz cele biznesowe, aby stworzyć stronę internetową w Olsztynie dopasowaną do Twoich oczekiwań."
            },
            {
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Olsztyna",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Olsztyna i okolic. Specjalizujemy się w:",
    },
    ...
    portfolio: {
        ...
        paragraph2: "Masz pomysł na stronę internetową w Olsztynie?"
    },

    faq: {
        title: "Tworzenie stron internetowych w Olsztynie - odpowiemy na wszystkie Twoje pytania",
        ...
        elements: [
            ...
            {
                id: 2,
                question: "Ile kosztuje strona w Olsztynie?",
