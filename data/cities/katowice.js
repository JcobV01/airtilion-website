import katowiceImg from '@public/assets/images/area/cities/katowice.webp'

export const katowice = {
    city: "Katowice",
    img: katowiceImg,
    metaTitle: "Strony www Katowice - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Katowice oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",
    ...
    header: {
        ...
        paragraph2: "Każda strona www Katowice jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },

    whyCity: {
        mainTitle: "Profesjonalne strony i sklepy internetowe Katowice",
        decoration: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        subTitle: "Projektowanie stron internetowych Katowice - nowoczesność i jakość w jednym miejscu",
        ...
        titleWhyInvest: "Dlaczego warto zainwestować w stronę internetową dla firmy w Katowicach?",
        elements: [
            {
            ...
            },
            {
                ...
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy z Katowic`,
            ...
            },
            {
                ...
                title: `Zdobędziesz klientów w Katowicach i okolicach`,
                desc: `Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów z Katowic.`
            }
        ]
    },

    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Katowicach",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Katowicach",
        ...
        elements: [
            {
                ...
                desc: "Na początku poznajemy specyfikę Twojej działalności oraz cele biznesowe, aby stworzyć stronę internetową w Katowicach dopasowaną do Twoich oczekiwań."
            },
            {
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Katowic",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Katowic i okolic. Specjalizujemy się w:",
    },
    ...
    portfolio: {
        ...
        paragraph2: "Masz pomysł na stronę internetową w Katowicach?"
    },

    faq: {
        title: "Tworzenie stron internetowych w Katowicach - odpowiemy na wszystkie Twoje pytania",
        ...
        elements: [
            ...
            {
                id: 2,
                question: "Ile kosztuje strona w Katowicach?",
