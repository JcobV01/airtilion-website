import bydgoszczImg from '@public/assets/images/area/cities/bydgoszcz.webp'

export const bydgoszcz = {
    city: "Bydgoszcz",
    img: bydgoszczImg,
    metaTitle: "Strony www Bydgoszcz - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Bydgoszcz oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",

    header: {
        h1: "Strony internetowe Bydgoszcz",
        ...
        paragraph2: "Każda strona www Bydgoszcz jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },

    whyCity: {
        mainTitle: "Profesjonalne strony i sklepy internetowe Bydgoszcz",
        decoration: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        subTitle: "Projektowanie stron internetowych Bydgoszcz - nowoczesność i jakość w jednym miejscu",
        ...
        titleWhyInvest: "Dlaczego warto zainwestować w stronę internetową dla firmy w Bydgoszczy?",
        elements: [
            {
            ...
            },
            {
                ...
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy z Bydgoszczy`,
    ...
    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Bydgoszczy",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Bydgoszczy",
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Bydgoszczy",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Bydgoszczy i okolic. Specjalizujemy się w:",
    },
    ...
    portfolio: {
        ...
        paragraph2: "Masz pomysł na stronę internetową w Bydgoszczy?"
    },

    faq: {
        title: "Tworzenie stron internetowych w Bydgoszczy - odpowiemy na wszystkie Twoje pytania",
        ...
        elements: [
            ...
            {
                id: 2,
                question: "Ile kosztuje strona w Bydgoszczy?",
