import gorzowwielkopolskiImg from '@public/assets/images/area/cities/gorzowwielkopolski.webp'

export const gorzowwielkopolski = {
    city: "Gorzów Wielkopolski",
    img: gorzowwielkopolskiImg,
    metaTitle: "Strony www Gorzów Wielkopolski - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Gorzów Wielkopolski oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",

    header: {
        h1: "Strony internetowe Gorzów Wielkopolski",
        ...
        paragraph2: "Każda strona www Gorzów Wielkopolski jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },

    whyCity: {
        mainTitle: "Profesjonalne strony i sklepy internetowe Gorzów Wielkopolski",
        decoration: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        subTitle: "Projektowanie stron internetowych Gorzów Wielkopolski - nowoczesność i jakość w jednym miejscu",
        ...
        titleWhyInvest: "Dlaczego warto zainwestować w stronę internetową dla firmy w Gorzowie Wielkopolskim?",
        elements: [
            {
            ...
            },
            {
                ...
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy z Gorzowa Wielkopolskiego`,
            ...
            },
            {
                ...
                title: `Zdobędziesz klientów w Gorzowie Wielkopolskim i okolicach`,
                desc: `Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów z Gorzowa Wielkopolskiego.`
            }
        ]
    },

    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Gorzowie Wielkopolskim",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Gorzowie Wielkopolskim",
        ...
        elements: [
            {
                ...
                desc: "Na początku poznajemy specyfikę Twojej działalności oraz cele biznesowe, aby stworzyć stronę internetową w Gorzowie Wielkopolskim dopasowaną do Twoich oczekiwań."
            },
            {
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Gorzowa Wielkopolskiego",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Gorzowa Wielkopolskiego i okolic. Specjalizujemy się w:",
    },
    ...
    portfolio: {
        ...
        paragraph2: "Masz pomysł na stronę internetową w Gorzowie Wielkopolskim?"
    },

    faq: {
        title: "Tworzenie stron internetowych w Gorzowie Wielkopolskim - odpowiemy na wszystkie Twoje pytania",
        ...
        elements: [
            ...
            {
                id: 2,
                question: "Ile kosztuje strona w Gorzowie Wielkopolskim?",
