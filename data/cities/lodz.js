import lodzImg from '@public/assets/images/area/cities/lodz.webp'

export const lodz = {
    city: "Łódź",
    img: lodzImg,
    metaTitle: "Strony www Łódź - projektowanie, tworzenie, sklepy internetowe, optymalizacja",
    metaDescription: "Projektujemy i tworzymy profesjonalne strony www Łódź oraz sklepy internetowe z CMS i kompleksową optymalizacją SEO. Sprawdź ofertę!",

    header: {
        h1: "Strony internetowe Łódź",
        ...
        paragraph2: "Każda strona www Łódź jest w pełni responsywna, szybka i bezpieczna. Obsługujemy klientów z regionu oraz z całej Polski - nie mamy ograniczeń geograficznych. Skontaktuj się z nami, a omówimy szczegóły współpracy, opowiemy o procesie tworzenia strony i przedstawimy darmową wycenę!"
    },

    whyCity: {
        mainTitle: "Profesjonalne strony i sklepy internetowe Łódź",
        decoration: "Z nami zyskujesz więcej niż tylko obecność w sieci",
        subTitle: "Projektowanie stron internetowych Łódź - nowoczesność i jakość w jednym miejscu",
        ...
        titleWhyInvest: "Dlaczego warto zainwestować w stronę internetową dla firmy w Łodzi?",
        elements: [
            {
            ...
            },
            {
                ...
                title: `Zbudujesz zaufanie i wiarygodność Twojej firmy z Łodzi`,
            ...
            },
            {
                ...
                title: `Zdobędziesz klientów w Łodzi i okolicach`,
                desc: `Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów z Łodzi.`
            }
        ]
    },

    technology: {
        title: "Bezpieczne systemy i&nbsp;technologie dla stron www w Łodzi",
    ...
    processCity: {
        title: "Proces projektowania i&nbsp;tworzenia stron www dla firm w Łodzi",
        ...
        elements: [
            {
                ...
                desc: "Na początku poznajemy specyfikę Twojej działalności oraz cele biznesowe, aby stworzyć stronę internetową w Łodzi dopasowaną do Twoich oczekiwań."
            },
            {
    ...
    offerCity: {
        title: "Nasza oferta strony www dla firm z Łodzi",
        paragraph1: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Łodzi i okolic. Specjalizujemy się w:",
    },
    ...
    portfolio: {
        ...
        paragraph2: "Masz pomysł na stronę internetową w Łodzi?"
    },

    faq: {
        title: "Tworzenie stron internetowych w Łodzi - odpowiemy na wszystkie Twoje pytania",
        ...
        elements: [
            ...
            {
                id: 2,
                question: "Ile kosztuje strona w Łodzi?",
