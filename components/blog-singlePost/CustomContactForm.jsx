    ...
    return (
        <div className='w-[600px] mx-auto flex flex-col'>
            ...
            <form onSubmit={handleSubmit} className='mt-[16px] flex flex-col gap-[20px] xl:gap-[0px] lg:gap-[15px] contactForm '>
                ...
                <input name="Email" value={email} onChange={(e) => setEmail(e.target.value)} type="email" className='xxl:text-[20px] bg-transparent outline-none border-b-[1px] border-b-[#FFF] py-[10px] xl:text-[13px]' placeholder='Adres e-mail' />
                ...
                <textarea name="Text" value={text} onChange={(e) => setText(e.target.value)} className='xxl:text-[20px] bg-transparent outline-none border-b-[1px] border-b-[#FFF] py-[10px] resize-none h-[150px] xl:h-[100px] xl:text-[13px]' placeholder='Wiadomość' />

                <div className='w-full flex gap-[5px] mt-[15px] xl:mt-[10px] sm:flex-col sm:items-center'>
                ...
                <div className='w-full flex gap-[5px] sm:items-center'>
                ...
                <div className='flex justify-end xl:mt-[10px] lg:mt-[0px] sm:justify-center'>
