...
const ButtonArea = ({ text, width }) => {
    return (
        <Link href="/portfolio" aria-label="Kliknij aby przejść do portfolio" className={`mt-[32px] flex w-[${width}px] h-[50px] duration-700 hover:scale-90`}>
