    ...
    return (
        <article id="opinion" className='w-[1240px] xxl:w-[1500px] xl:w-[90%] observer'>
            ...
            <div className='flex flex-col w-full justify-center items-center gap-[40px] relative fold:gap-[20px]'>
                ...
                <p className='z-20 text-[18px] text-center mb-[30px] xxl:text-[20px]'>{client.opinion}</p>
                <p className='z-20 text-[20px] text-center text-[#A8A8A8] xxl:text-[22px]'>~ {client.author}</p>
