    ...
    return (
        <article id="client" className='w-full observer'>
            ...
            <div className='w-full py-[140px] flex items-center gap-[120px] justify-center relative lg:flex-col fold:gap-[50px]'>
                <div className='absolute top-0 left-0 w-full h-full transparent-x z-10 brightness-[0.2] bg-no-repeat bg-cover md:bg-center' style={{ backgroundImage: `url(${client.background})` }}></div>
