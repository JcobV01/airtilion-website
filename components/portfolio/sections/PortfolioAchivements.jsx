...
const PortfolioAchivements = ({achivement}) => {
    return (
        <article id="achivements" className='w-[1400px] xxl:w-[1500px] 2xl:w-[90%] observer'>
            <h5 className='text-[20px] tracking-[3px] text-[#E2B350] mb-[60px] xxl:text-[24px] sm:text-center'>CO UDAŁO SIĘ OSIĄGNĄĆ?</h5>
