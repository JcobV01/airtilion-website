    ...
    return (
        <article id="images" className='relative h-[446px] w-dvw flex xl:flex-col xl:items-center xl:h-auto xl:w-[90%] observer'>
            ...
            <Image 
                ...
                className='w-[870px] h-[450px] object-cover absolute left-[50%] translate-x-[-50%] z-20 rounded-[10px] xl:relative xl:left-auto xl:translate-x-0' />
            <Image 
                ...
                className='w-[740px] h-[380px] object-cover absolute left-0 top-0 z-10 brightness-50 xl:relative xl:top-auto xl:left-auto' />
            <Image 
                ...
                className='w-[740px] h-[380px] object-cover absolute right-0 bottom-0 z-10 brightness-50 xl:relative xl:right-auto xl:bottom-auto' />
