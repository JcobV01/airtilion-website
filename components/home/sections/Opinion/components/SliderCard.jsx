...
const SliderCard = ({author, page, desc, key}) => {
    return (
        <div className='h-[250px] w-[420px] bg-[rgba(16,16,16,0.40)] rounded-[10px] backdrop-blur-[2.5px] px-[15px] py-[15px] relative' key={key}>
            ...
            <div className='flex gap-[50px] z-10 relative'>
                ...
                <div className='flex flex-col'>
                    <h5 className='text-[20px] font-extralight tracking-[1px]'>{author}</h5>
                    <span className='pl-[15px] text-[#AEAEAE] text-[16px] font-extralight lg:text-[13px]'>{page}</span>
                </div>
            </div>
            <p className='text-[16px] font-extralight mt-[15px] px-[15px] z-10 relative lg:text-[14px]'>{desc}</p>
