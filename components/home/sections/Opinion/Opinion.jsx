...
const Opinion = () => {
  ...
  return (
    <section ref={ref} className={`w-[1400px] 2xl:w-[80%] m-auto flex flex-col gap-[50px] relative z-10 transition-all duration-1000 ease-in-out ${isVisible ? 'about-visible' : 'about-hidden'}`}>
