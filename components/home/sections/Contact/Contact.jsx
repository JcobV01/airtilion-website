...
const Contact = () => {
    ...
    return (
        <section ref={ref} id="kontakt" className={`relative z-10 w-full flex justify-center xl:w-[90%] m-auto bg-cover bg-no-repeat bg-center transition-all duration-1000 ease-in-out ${isVisible ? 'about-visible' : 'about-hidden'} observer-navbar`} style={{ backgroundImage: isLargeScreen && `url(${bg.src})` }}>
            <svg
