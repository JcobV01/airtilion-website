  ...
  return (
    <section className='relative w-[1240px] 2xl:w-[80%] m-auto flex flex-col gap-[150px] z-10'>
      <article className='flex gap-[50px] z-10 xl:gap-[30px] lg:gap-[50px] lg:flex-col'>
        <Image src={mainImage} width={420} height={290} alt="Obrazek wyróżniający sekcję O nas" className='w-[420px] h-[290px] rounded-[10px] xl:w-[400px] xl:h-[400px] lg:w-full lg:h-[300px] object-cover' />
