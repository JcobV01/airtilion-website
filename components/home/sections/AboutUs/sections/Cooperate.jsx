...
const Cooperate = () => {
  ...
  return (
    <article ref={ref} className={`w-full h-[450px] lg:h-[350px] sm:h-auto sm:py-[50px] flex flex-col items-center relative px-[170px] xl:px-[100px] lg:px-[50px] sm:px-[30px] gap-[40px] xl:gap-[30px] justify-center bg-center transition-all duration-1000 ease-in-out ${isVisible ? 'about-visible' : 'about-hidden'}`}>
        <Image src={coopBg} alt="Obrazek przedstawiający jednego z założycieli Airtlionu" width="auto" height="450"  className="absolute w-full h-[450px] lg:h-[350px] sm:h-auto object-cover xxl:bg-cover xxl:bg-no-repeat"/>
        <div className='z-10'>
        ...
        <Link href="/#contact" className='z-10 duration-700 hover:scale-90'>
