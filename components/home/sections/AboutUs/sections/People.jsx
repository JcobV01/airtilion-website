            ...
            <section className={`flex flex-col items-center mt-[100px] gap-[70px] transition-all duration-1000 ease-in-out ${isVisible ? 'element-visible-right' : 'element-hidden-right'}`}>
                ...
                <div className={`flex flex-row-reverse gap-[60px] w-[940px] xl:w-[100%] relative p-[25px] lg:flex-col lg:items-center transition-all duration-1000 ease-in-out ${isVisible ? 'element-visible-left' : 'element-hidden-left'}`}>
                    ...
                    <div className='flex-1 flex flex-col gap-[20px] lg:items-center'>
                        ...
                        <p className='text-[16px] xl:text-[15px] lg:text-[13px] font-light lg:text-center'>Z wykształcenia jestem technikiem elektronikiem, ale to właśnie pasja do technologii i informatyki skierowała mnie na ścieżkę programowania. Od czterech lat rozwijam swoje umiejętności jako full stack developer. W mojej pracy szczególnie cenię sobie połączenie technologii z kreatywnymi pomysłami, co pozwala mi dostarczać nowoczesne i funkcjonalne rozwiązania.<br /><br />Moim celem jest rewolucjonizowanie branży stron i sklepów internetowych poprzez wdrażanie nowoczesnych i zaawansowanych technologicznie rozwiązań. Obserwując obojętność części firm na rozwój i potrzeby klientów, stawiam na świeże podejście, które ma na celu nie tylko spełnianie oczekiwań, ale także wyznaczanie nowych standardów w branży.</p>
                    </div>
