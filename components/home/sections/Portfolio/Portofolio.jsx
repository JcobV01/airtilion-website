...
const Portofolio = () => {
    ...
    return (
        <section className='z-10 w-[1240px] xl:w-[80%] m-auto flex flex-col gap-[50px] relative'>
            ...
            {data?.slice(0, 3).map((item) => (
                <PortfolioItem title={item.Name} desc={item.Description} bg={item.Background} image={item.Screens[0]} key={item._id} />
            ))}
