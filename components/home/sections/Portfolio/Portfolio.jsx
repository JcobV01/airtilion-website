...
const Portfolio = () => {
    ...
    return (
        <section  ref={ref} id="portfolio" className={`z-10 w-[1240px] xxl:w-[1500px] xl:w-[80%] m-auto flex flex-col gap-[50px] relative transition-all duration-1000 ease-in-out ${isVisible ? 'about-visible' : 'about-hidden'} observer-navbar`}>
