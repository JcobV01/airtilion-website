    ...
    return (
        <React.Fragment>
                <div className={`flex gap-[12px] group ${index === 0 && 'flex-col gap-[16px]'}`}>
                    ...
                    <p className={`text-[18px] line-clamp-3 group-hover:text-[#ABABAB] duration-500 ${index !== 0 && 'font-light'} blur-[5px] xl:text-[16px]`}>Airtilion - nowoczesne i profesjonalne strony internetowe</p>
                </div>
