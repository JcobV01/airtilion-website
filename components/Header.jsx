...
const Header = ({title, subtitle, img}) => {
  return (
    <header className='w-full h-dvh bg-no-repeat bg-cover relative top-[-133px] flex justify-center items-center z-10 bg-bottom' style={{backgroundImage: `url(${img.src})`}}>
