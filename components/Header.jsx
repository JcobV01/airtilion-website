...
const Header = ({title, subtitle, img}) => {
  return (
    <header className='w-full h-dvh relative top-[-133px] flex justify-center items-center z-10'>
        <Image src={img.src} layout="fill" objectFit='cover' alt="Tło nagłówka" loading="eager" sizes="100vw" priority className="absolute bg-no-repeat" style={{backgroundPosition: 'center calc(100% + 10px)'}}/>
