  ...
  return (
    <>
      ...
      <main className='flex flex-col relative mt-[-250px] gap-[200px] md:gap-[100px]'>
        ...
        <div className='absolute top-[550px] 2xl:top-[400px] left-[50%] translate-x-[-50%] z-[1] w-full'>
        ...
        <div className='absolute top-[2300px] 2xl:top-[2600px] left-[50%] translate-x-[-50%] z-[1] w-full'>
