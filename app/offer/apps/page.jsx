  ...
  return (
    <>
      ...
      <section>
        ...
        <div className='absolute top-[1250px] xl:top-[1300px] lg:hidden left-[50%] translate-x-[-50%] z-[1] w-full opacity-50'>
        ...
        <div className='absolute top-[3450px] lg:hidden left-[50%] translate-x-[-50%] z-[1] w-full opacity-50'>
