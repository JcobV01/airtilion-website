  ...
  return (
    <>
      ...
      <section>
        ...
        <div className='absolute top-[650px] xxl:hidden lg:top-[750px] sm:top-[1050px] lg:hidden left-[50%] translate-x-[-50%] z-[1] w-full opacity-50'>
        ...
        <div className='absolute top-[1750px] xxl:hidden sm:top-[1900px] lg:hidden left-[50%] translate-x-[-50%] z-[1] w-full opacity-50'>
        ...
        <div className='absolute top-[2850px] xxl:hidden lg:hidden left-[50%] translate-x-[-50%] z-[1] w-full opacity-50'>
