...
const page = () => {
  ...
  return (
    <section className='w-[1240px] flex flex-col gap-[100px]'>
        ...
        <nav className='flex relative gap-[40px] px-[40px] py-[20px] w-max m-auto'>
            <span className='absolute w-[326px] h-full top-0 left-0 rounded-full border-[#E2B350] border-l-[3px] z-10'></span>
            ...
            <span className='absolute w-[326px] h-full top-0 right-0 rounded-full border-[#E2B350] border-r-[3px] z-10'></span>
        </nav>
