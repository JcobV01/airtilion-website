...
import opole from '@public/assets/images/area/cities/opole.webp'
...
const cityData = {
  firstSection: {
    ...
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe w Opolu – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową w Opolu?",
      image: opole,
      elements: [
        {
        ...
        },
        {
          ...
          desc: "Profesjonalne strony przyciągają nowych klientów z Opola i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH W OPOLU",
    desc: "Tworzenie stron internetowych w Opolu",
    question: "Chcesz stworzyć profesjonalną stronę internetową w Opolu?",
    elements: [
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę w Opolu i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Opola i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów z Opola, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej w Opolu!",
        bg: fifthCard
      },
    ],
  },
