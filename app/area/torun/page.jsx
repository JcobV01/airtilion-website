...
import torun from '@public/assets/images/area/cities/torun.webp'
...
const cityData = {
  firstSection: {
    ...
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe w Toruniu – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową w Toruniu?",
      image: torun,
      elements: [
        {
          ...
          desc: "Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów z Torunia"
        },
        {
          icon: "material-symbols:trophy",
          iconText: "PRZEWAGA NAD KONKURENCJĄ",
          title: "Wyróżnisz się na tle konkurencji",
          desc: "Profesjonalne strony przyciągają nowych klientów z Torunia i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH W TORUNIU",
    desc: "Tworzenie stron internetowych w Toruniu",
    question: "Chcesz stworzyć profesjonalną stronę internetową w Toruniu?",
    elements: [
      {
        icon: "mdi:clipboard-text",
        title: "Analiza potrzeb klienta",
        desc: "Na początku poznajemy specyfikę Twojej działalności oraz cele biznesowe, aby stworzyć stronę internetową w Toruniu dopasowaną do Twoich oczekiwań."
      },
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę w Toruniu i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Torunia i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów z Torunia, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej w Toruniu!",
        bg: fifthCard
      },
    ],
  },
