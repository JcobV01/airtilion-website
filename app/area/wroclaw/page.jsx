...
import wroclaw from '@public/assets/images/area/cities/wroclaw.webp'
...
const cityData = {
  firstSection: {
    ...
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe we Wrocławiu – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową we Wrocławiu?",
      image: wroclaw,
      elements: [
        {
        ...
        },
        {
          ...
          desc: "Profesjonalne strony przyciągają nowych klientów z Wrocławia i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH WE WROCŁAWIU",
    desc: "Tworzenie stron internetowych we Wrocławiu",
    question: "Chcesz stworzyć profesjonalną stronę internetową we Wrocławiu?",
    elements: [
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę we Wrocławiu i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Wrocławia i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów z Wrocławia, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej we Wrocławiu!",
        bg: fifthCard
      },
    ],
  },
...
const page = () => {
  return (
    <>
      <CityComponent city="we Wrocławiu" />
      ...
      <CityPortfolio city="we Wrocławiu" />
