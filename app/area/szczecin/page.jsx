...
import szczecin from '@public/assets/images/area/cities/szczecin.webp'
...
const cityData = {
  firstSection: {
    ...
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe w Szczecinie – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową w Szczecinie?",
      image: szczecin,
      elements: [
        {
          ...
          desc: "Zwiększ zasięg swojego biznesu i przyciągnij nowych klientów ze Szczecina"
        },
        {
          icon: "material-symbols:trophy",
          iconText: "PRZEWAGA NAD KONKURENCJĄ",
          title: "Wyróżnisz się na tle konkurencji",
          desc: "Profesjonalne strony przyciągają nowych klientów ze Szczecina i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH W SZCZECINIE",
    desc: "Tworzenie stron internetowych w Szczecinie",
    question: "Chcesz stworzyć profesjonalną stronę internetową w Szczecinie?",
    elements: [
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę w Szczecinie i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów ze Szczecina i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów ze Szczecina, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej w Szczecinie!",
        bg: fifthCard
      },
    ],
  },
...
const page = () => {
  return (
    <>
      <CityComponent city="w Szczecinie" />
      ...
      <CityPortfolio city="w Szczecinie" />
