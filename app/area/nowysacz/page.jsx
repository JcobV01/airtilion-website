...
import nowysacz from '@public/assets/images/area/cities/nowysacz.webp'
...
const cityData = {
  firstSection: {
    title: "Strony internetowe Nowy Sącz",
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe w Nowym Sączu – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową w Nowym Sączu?",
      image: nowysacz,
      elements: [
        {
        ...
        },
        {
          ...
          desc: "Profesjonalne strony przyciągają nowych klientów z Nowego Sącza i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH W NOWYM SĄCZU",
    desc: "Tworzenie stron internetowych w Nowym Sączu",
    question: "Chcesz stworzyć profesjonalną stronę internetową w Nowym Sączu?",
    elements: [
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę w Nowym Sączu i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Nowego Sącza i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów z Nowego Sącza, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej w Nowym Sączu!",
        bg: fifthCard
      },
    ],
  },
...
const page = () => {
  return (
    <>
      <CityComponent city="w Nowym Sączu" />
      ...
      <CityPortfolio city="w Nowym Sączu" />
