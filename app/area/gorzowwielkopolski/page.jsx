...
import gorzowwielkopolski from '@public/assets/images/area/cities/gorzowwielkopolski.webp'
...
const cityData = {
  firstSection: {
    title: "Strony internetowe Gorzów Wielkopolski",
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe w Gorzowie Wielkopolskim – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową w Gorzowie Wielkopolskim?",
      image: gorzowwielkopolski,
      elements: [
        {
        ...
        },
        {
          ...
          desc: "Profesjonalne strony przyciągają nowych klientów z Gorzowa Wielkopolskiego i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH W GORZOWIE WIELKOPOLSKIM",
    desc: "Tworzenie stron internetowych w Gorzowie Wielkopolskim",
    question: "Chcesz stworzyć profesjonalną stronę internetową w Gorzowie Wielkopolskim?",
    elements: [
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę w Gorzowie Wielkopolskim i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Gorzowa Wielkopolskiego i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów z Gorzowa Wielkopolskiego, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej w Gorzowie Wielkopolskim!",
        bg: fifthCard
      },
    ],
  },
...
const page = () => {
  return (
    <>
      ...
      <CityPortfolio city="w Gorzowie Wielkopolskim" />
