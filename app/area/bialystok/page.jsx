...
import bialystok from '@public/assets/images/area/cities/bialystok.webp'
...
const cityData = {
  firstSection: {
    ...
    content: "Twoja firma zasługuje na stronę, która przyciąga klientów i dominuje w Google! Tworzymy nowoczesne strony internetowe w Białymstoku – szybkie, responsywne i zoptymalizowane pod SEO. Postaw na jakość i technologię przyszłości!",
    tiles: {
      title: "Dlaczego warto zainwestować w stronę internetową w Białymstoku?",
      image: bialystok,
      elements: [
        {
        ...
        },
        {
          ...
          desc: "Profesjonalne strony przyciągają nowych klientów z Białegostoku i okolic"
        },
        {
  ...
  process: {
    title: "PROCES TWORZENIA STRON INTERNETOWYCH W BIAŁYMSTOKU",
    desc: "Tworzenie stron internetowych w Białymstoku",
    question: "Chcesz stworzyć profesjonalną stronę internetową w Białymstoku?",
    elements: [
      {
      ...
      },
      {
        ...
        desc: "Publikujemy gotową stronę w Białymstoku i oferujemy pomoc techniczną po jej uruchomieniu, aby wszystko działało sprawnie od samego początku."
      },
    ],
  },
  offer: {
    desc: "Tworzymy nowoczesne, szybkie i przyjazne SEO strony internetowe, które przyciągną klientów z Białegostoku i okolic. Specjalizujemy się w:",
    elements: [
      {
        title: "Strony wizytówki",
        desc: "Idealne dla małych firm i freelancerów z Białegostoku, które chcą zaprezentować się online.",
        bg: firstCard,
      ...
      },
      {
        ...
        desc: "Masz pytania? Chcesz poznać koszt strony dostosowanej do Twoich potrzeb? Wypełnij formularz, a przygotujemy dla Ciebie spersonalizowaną ofertę dla strony internetowej w Białymstoku!",
        bg: fifthCard
      },
    ],
  },
...
const page = () => {
  return (
    <>
      <CityComponent city="w Białymstoku" />
      ...
      <CityPortfolio city="w Białymstoku" />
